...
if (isset($_POST['edit'])){
    ...
    if(empty($id)){
        ...
        if ($edit){
            ...
            echo "<script>alert('Gagal edit petugas');location.href='petugas.php';</script>";
        }
    }else{
...
if (isset($_POST['ubahpassword'])){
    ...
    if ($pw2 == $pw3){
        ...
        echo "<script>alert('Masukkan Ulang Password Dengan Benar');location.href='petugas.php'</script>";
    }
}
?>
